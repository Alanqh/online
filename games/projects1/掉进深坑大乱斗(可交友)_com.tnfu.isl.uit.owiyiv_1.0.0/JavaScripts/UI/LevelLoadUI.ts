 ...
 */
import LevelLoadUI_Generate from "../ui-generate/LevelLoadUI_generate";
export default class LevelLoadUI extends LevelLoadUI_Generate {
	...
	public ShowLevelUIById(levelId:number):void{
		levelId = levelId + 1;
		if(levelId == 1) this.ShowLevel1UI();
		if(levelId == 2) this.ShowLevel2UI();
		if(levelId == 3) this.ShowLevel3UI();
		if(levelId == 4) this.ShowLevel4UI();
	}

	//显示关卡1UI
	public ShowLevel1UI():void {
