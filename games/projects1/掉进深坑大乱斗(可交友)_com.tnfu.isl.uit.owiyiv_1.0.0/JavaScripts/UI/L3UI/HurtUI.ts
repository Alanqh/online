 ...
 */
import HurtUI_Generate from "../../ui-generate/L3UI/HurtUI_generate";
export default class HurtUI extends HurtUI_Generate {
	...
	protected onStart() {
		...
		Event.addServerListener("UpdateHurt",(num:number)=>{
			let damage = num/30*100;
			//保留一位小数
			damage = Math.round(damage*10)/10;
			if(damage > 100.0) damage = 100;
