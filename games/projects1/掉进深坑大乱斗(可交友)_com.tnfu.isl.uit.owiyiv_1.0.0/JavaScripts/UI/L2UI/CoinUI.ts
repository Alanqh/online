 ...
 */
import CoinUI_Generate from "../../ui-generate/L2UI/CoinUI_generate";
export default class CoinUI extends CoinUI_Generate {
	...
	protected onStart() {
		...
		Event.addServerListener("UpdateCoin",(num:number)=>{
