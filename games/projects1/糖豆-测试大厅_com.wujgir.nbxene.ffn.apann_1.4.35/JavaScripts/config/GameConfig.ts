...
import {GameParamConfig} from "./GameParam";
...
import {WallGroupConfig} from "./WallGroup";
...
export class GameConfig{
	...
	*/
	...
	public static get GameParam():GameParamConfig{ return this.getConfig(GameParamConfig) };
	...
	public static get Graph():GraphConfig{ return this.getConfig(GraphConfig) };
	...
	public static get Points():PointsConfig{ return this.getConfig(PointsConfig) };
	...
	public static get Wall():WallConfig{ return this.getConfig(WallConfig) };
	public static get WallGroup():WallGroupConfig{ return this.getConfig(WallGroupConfig) };
