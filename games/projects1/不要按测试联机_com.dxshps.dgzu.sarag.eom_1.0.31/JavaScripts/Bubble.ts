...
export class Bubble {
     ...
     * z轴基础高度
     */
    private _baseHeight: number = 80;

    /**
     * z轴基础高度（四足）
     */
    private _fourFootBaseHeight: number = 100;
     ...
     */
    constructor(_object, _uiPool, _text, _onMeasureCallback, height: number, fourFootHeight: number) {
        ...
        this._fourFootBaseHeight = fourFootHeight;
    ...
    */
    ...
    updatePosition() {
        if (this.localCharacter) {
            ...
            loc.z += this.localCharacter.characterType == CharacterType.FourFootStandard ? this._fourFootBaseHeight : this._baseHeight;
     ...
     */
    public setVisibility(visibility: SlateVisibility) {
        this._ui.rootCanvas.visibility = visibility;
    }
}
