declare module "module_leaderboard" {
    ...
    export class LeaderboardModuleBaseC<T extends LeaderboardModuleBaseS<any>> extends mwext.ModuleC<T, null> {
    ...
    export abstract class LeaderboardModuleBaseS<T extends LeaderboardModuleBaseC<any>> extends mwext.ModuleS<T, null> {
         ...
         * @returns 是否成功
         */
        addPlayer(player: mw.Player | number, data: {
            [fieldId: number]: number | string;
        }): boolean;
        /**
         * 从排行榜移除一个玩家
         ...
         * @returns 是否成功
         */
        removePlayer(player: mw.Player | number): boolean;
        /**
         * 设置玩家的一个字段值
         * @param player 玩家对象|玩家id
         * @param fieldId 字段ID
         * @param value 字段的值
         */
        setPlayerValue(player: mw.Player | number, fieldId: number, value: number | string): void;
        /**
         * 清除排行榜
         */
        clear(): void;
...
declare module "module_leaderboard" {
    interface IItemView extends mw.UIScript {
        mContent: mw.Canvas;
    }
    interface IPanelView extends mw.UIScript {
    ...
    export abstract class LeaderboardBaseItem<T extends IItemView> extends mwext.BasePanel<T> {
    ...
    export abstract class LeaderboardBasePanel<T extends IPanelView> extends mwext.BasePanel<T> {
...
declare module "module_leaderboard" {
    ...
    export class Leaderboard {
         ...
         * @param data 玩家数据
         */
        addPlayer(player: mw.Player | number, data?: any): void;
        /**
         * 从排行榜移除一个玩家
         * @param player 玩家对象|玩家id
         * @returns
         */
        removePlayer(player: mw.Player | number): void;
        /**
         * 设置一个玩家的一个字段值
         * @param player 玩家对象|玩家id
         * @param fieldId 字段的ID
