...
@UIBind('UI/ChampionUI.ui')
export default class ChampionUI_Generate extends UIScript {
	...
	private enUI_1_1_Internal: mw.Image
	public get enUI_1_1(): mw.Image {
		if(!this.enUI_1_1_Internal&&this.uiWidgetBase) {
			this.enUI_1_1_Internal = this.uiWidgetBase.findChildByPath('RootCanvas/mCanvasMove/enUI_1_1') as mw.Image
		}
		return this.enUI_1_1_Internal
	}
