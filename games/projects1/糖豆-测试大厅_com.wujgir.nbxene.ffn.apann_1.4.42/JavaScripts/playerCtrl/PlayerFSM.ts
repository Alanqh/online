...
class SlipState extends StateBase {
    ...
    override update(dt: number) {
        if (PlayerComponentMgr.ins.isCharacterSpeedLow(this.character.character) || !PlayerComponentMgr.ins.isCharacterOnGround() || (this._currentFrontSlope == EFrontSlope.Down && PlayerComponentMgr.ins._speedComponent.currentFrontSlope == EFrontSlope.Ground)) {
