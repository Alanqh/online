...
export class GeneralManager {
    ...
    public static async asyncRpcGetPlayer(playerid: number): Promise<mw.Player> {
        const player = await Player.asyncGetPlayer(playerid);
    ...
    public static rpcPlayEffectOnPlayer(source: string, target: mw.Player | Character, slotType: mw.HumanoidSlotType, loopCount?: number, offset?: mw.Vector, rotation?: mw.Rotation, scale?: mw.Vector): number {
