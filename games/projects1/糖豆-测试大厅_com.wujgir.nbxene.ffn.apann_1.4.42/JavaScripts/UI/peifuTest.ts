 ...
 * TIME: 2023.02.19-10.14.37
 */

import window_Generate from "../ui-generate/飞扑参数/window_generate";

export default class peifuTest extends window_Generate {
