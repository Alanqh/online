...
export default class GravityArea extends mw.Script {
    ...
    protected onStart(): void {
        ...
        trigger.onEnter.add((go: mw.Character) => {
            if (go instanceof mw.Pawn && !this.characters.includes(go)) {
                go.gravityScale = 0;
                go.addImpulse(mw.Vector.multiply(trigger.worldTransform.getUpVector(), 1500, TEMP));
        ...
        //后方向量
        mw.Vector.multiply(trigger.worldTransform.getUpVector(), -40, this.rootPoint);
