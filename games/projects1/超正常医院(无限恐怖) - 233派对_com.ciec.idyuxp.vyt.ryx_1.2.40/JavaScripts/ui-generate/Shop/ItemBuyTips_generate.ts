...
@UIBind('UI/Shop/ItemBuyTips.ui')
export default class ItemBuyTips_Generate extends UIScript {
	...
	public get mCanvas_Item(): mw.Canvas {
		if(!this.mCanvas_Item_Internal&&this.uiWidgetBase) {
			this.mCanvas_Item_Internal = this.uiWidgetBase.findChildByPath('Canvas/BodyCanvas/ScrollBox/mCanvas_Item') as mw.Canvas
		}
