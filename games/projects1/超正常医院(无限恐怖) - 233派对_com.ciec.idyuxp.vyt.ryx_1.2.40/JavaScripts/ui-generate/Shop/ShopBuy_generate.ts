...
export default class ShopBuy_Generate extends UIScript {
	...
	public get mCanvas_Select(): mw.Canvas {
		if(!this.mCanvas_Select_Internal&&this.uiWidgetBase) {
			this.mCanvas_Select_Internal = this.uiWidgetBase.findChildByPath('RootCanvas/mCanvas/mCanvas_Select') as mw.Canvas
		}
		return this.mCanvas_Select_Internal
	}
	private mButton_Num_Internal: mw.Button
	public get mButton_Num(): mw.Button {
		if(!this.mButton_Num_Internal&&this.uiWidgetBase) {
			this.mButton_Num_Internal = this.uiWidgetBase.findChildByPath('RootCanvas/mCanvas/mCanvas_Select/mButton_Num') as mw.Button
		}
		return this.mButton_Num_Internal
	}
	private mButton_Add_Internal: mw.Button
	public get mButton_Add(): mw.Button {
		if(!this.mButton_Add_Internal&&this.uiWidgetBase) {
			this.mButton_Add_Internal = this.uiWidgetBase.findChildByPath('RootCanvas/mCanvas/mCanvas_Select/mButton_Add') as mw.Button
		}
		return this.mButton_Add_Internal
	}
	private mButton_Reduce_Internal: mw.Button
	public get mButton_Reduce(): mw.Button {
		if(!this.mButton_Reduce_Internal&&this.uiWidgetBase) {
			this.mButton_Reduce_Internal = this.uiWidgetBase.findChildByPath('RootCanvas/mCanvas/mCanvas_Select/mButton_Reduce') as mw.Button
		}
		return this.mButton_Reduce_Internal
	}
	private mText_num_Internal: mw.TextBlock
	public get mText_num(): mw.TextBlock {
		if(!this.mText_num_Internal&&this.uiWidgetBase) {
			this.mText_num_Internal = this.uiWidgetBase.findChildByPath('RootCanvas/mCanvas/mCanvas_Select/mText_num') as mw.TextBlock
		}
	...
	public get mButton_Buy(): mw.Button {
		if(!this.mButton_Buy_Internal&&this.uiWidgetBase) {
			this.mButton_Buy_Internal = this.uiWidgetBase.findChildByPath('RootCanvas/mCanvas/mButton_Buy') as mw.Button
		}
	...
	protected initButtons() {
		...
		this.mButton_Num.onClicked.add(()=>{
			Event.dispatchToLocal("PlayButtonClick", "mButton_Num");
		})
		
	
		this.mButton_Add.onClicked.add(()=>{
			Event.dispatchToLocal("PlayButtonClick", "mButton_Add");
		})
		
	
		this.mButton_Reduce.onClicked.add(()=>{
			Event.dispatchToLocal("PlayButtonClick", "mButton_Reduce");
		})
