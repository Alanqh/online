...
export default class MessageBox_Generate extends UIScript {
	...
	private mNo_btn_Internal: mw.Button
	public get mNo_btn(): mw.Button {
		if(!this.mNo_btn_Internal&&this.uiWidgetBase) {
			this.mNo_btn_Internal = this.uiWidgetBase.findChildByPath('Canvas/BodyCanvas/mNo_btn') as mw.Button
		}
		return this.mNo_btn_Internal
	}
	private mText_Konw_1_Internal: mw.TextBlock
	public get mText_Konw_1(): mw.TextBlock {
		if(!this.mText_Konw_1_Internal&&this.uiWidgetBase) {
			this.mText_Konw_1_Internal = this.uiWidgetBase.findChildByPath('Canvas/BodyCanvas/mText_Konw_1') as mw.TextBlock
		}
		return this.mText_Konw_1_Internal
	}
	...
	protected initButtons() {
		...
		this.initLanguage(this.mText_Konw_1)
