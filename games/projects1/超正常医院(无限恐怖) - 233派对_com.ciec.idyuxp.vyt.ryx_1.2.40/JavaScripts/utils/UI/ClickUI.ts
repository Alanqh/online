import SP_InteractiveUI_Generate from "../../ui-generate/RP/SP_InteractiveUI_generate";
...
export class ClickUIPools {
    ...
    public show(iconGuid: string, content: string, obj: mw.GameObject, offset: mw.Vector, callBack: Function): void {
        ...
        let root = mw.createUIByName("RP/Main_interact");
        if (!root) {
            return null;
        }
...
class ClickUI {
    ...
    public async show(guid: string, content: string, obj: mw.GameObject, offset: mw.Vector, callBack: Function){
        ...
        if(this.obj){
            await this.obj.asyncReady();
        }
        // #js callback exception /data/user/0/com.meta.box/files/UE4Game/MetaWorldMobile/MetaWorldMobile/Saved/MetaWorld/Project/Game/P_7a27bd592cd4249b2fed814be7eb20fcbf1f2fd9/1.1.31/dist/game.js:44971: TypeError: Cannot read property 'add' of undefined
