 ...
 * @LastEditTime : 2023-09-06 14:08:38
 * @FilePath     : \stumbleguys\JavaScripts\Prefabs\GameStater\Script\LifeState.ts
 * @Description  : 
 */
...
class StateChooseMap extends GameStateBase {
    ...
    onStateUpdate(dt: number) {
        this._curStateTime += dt;
        if (this._curStateTime >= this.owner.config.chooseMapTime) {
