...
/** 
 * AUTHOR: 玉砌似画染11111111111
 * TIME: 2023.02.17-15.45.36
 */

import ExpresionUI_Generate from "../ui-generate/ExpresionUI_generate";

export default class UIExpression extends ExpresionUI_Generate {
	...
	protected onStart() {
		...
		// this.expression_Btn.onPressed.add(() => {
		// 	mw.UIService.getUI(HallUI).changeCanvasSize(this.expression_Btn);
		// })
		// this.expression_Btn.onReleased.add(() => {
		// 	mw.UIService.getUI(HallUI).changeCanvasSmoll(this.expression_Btn);
		// })
	}
	...
	*/
	 ...
	 */
	//protected onDragLeave(InGeometry :mw.Geometry,InDragDropEvent:mw.PointerEvent) {
	//}

	/**
	 * 拖拽操作生成事件触发后，没有完成完成的拖拽事件而取消时触发
	 */
	//protected onDragCancelled(InGeometry :mw.Geometry,InDragDropEvent:mw.PointerEvent) {
	//}
