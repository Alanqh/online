...
export class LanguageConfig extends ConfigBase<ILanguageElement>{
	...
	/**Jingle bells, jingle bells, Jingle all the way! Along with the winter chill, Candy Party brings you a new version! In this update, a long-awaited mode has been added – the Score Match. What exactly does this update include? Let's find out!
...
2. Pass UI optimization
3. Shop UI optimization
4. Reset button added in the lobby*/
	get UI_LAN_214():ILanguageElement{return this.getElement(266)};
	/**Candy Update Announcement*/
...
As mortals, we can not reach.*/
	...
	/**Gifts have appeared in the four corners of the map and at the highest point. Hurry and pick them up!*/
