 ...
 * TIME: 2023.02.19-10.22.34
 */

import button_Generate from "../ui-generate/飞扑参数/button_generate";
import peifuTest from "./peifuTest";

export default class mButtonUI extends button_Generate {
