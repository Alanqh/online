 ...
 export default class BagOperate_UI_Generate extends UIScript {
	...
	public get scroll(): mw.ScrollBox {
		if(!this.scroll_Internal&&this.uiWidgetBase) {
			this.scroll_Internal = this.uiWidgetBase.findChildByPath('RootCanvas/canvas_introduce/scroll') as mw.ScrollBox
		}
	...
	public get canvas(): mw.Canvas {
		if(!this.canvas_Internal&&this.uiWidgetBase) {
			this.canvas_Internal = this.uiWidgetBase.findChildByPath('RootCanvas/canvas_introduce/scroll/canvas') as mw.Canvas
		}
	...
	public get text_introduce(): mw.TextBlock {
		if(!this.text_introduce_Internal&&this.uiWidgetBase) {
			this.text_introduce_Internal = this.uiWidgetBase.findChildByPath('RootCanvas/canvas_introduce/scroll/canvas/text_introduce') as mw.TextBlock
		}
