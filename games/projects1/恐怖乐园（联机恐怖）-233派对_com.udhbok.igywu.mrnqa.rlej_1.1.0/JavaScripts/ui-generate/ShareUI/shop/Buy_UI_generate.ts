 ...
 export default class Buy_UI_Generate extends UIScript {
	...
	public get text_cardingDesc(): mw.TextBlock {
		if(!this.text_cardingDesc_Internal&&this.uiWidgetBase) {
			this.text_cardingDesc_Internal = this.uiWidgetBase.findChildByPath('RootCanvas/canvas_buy/canvas_buydetail/canvas_confirm/text_cardingDesc') as mw.TextBlock
		}
	...
	protected initButtons() {
		...
		this.text_buytitle.isRichText = true;
