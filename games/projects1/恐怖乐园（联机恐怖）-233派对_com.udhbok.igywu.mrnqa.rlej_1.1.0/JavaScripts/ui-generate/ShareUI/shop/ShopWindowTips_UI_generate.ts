 ...
 export default class ShopWindowTips_UI_Generate extends UIScript {
	...
	public get btn_cancel(): mw.Button {
		if(!this.btn_cancel_Internal&&this.uiWidgetBase) {
			this.btn_cancel_Internal = this.uiWidgetBase.findChildByPath('RootCanvas/canvas_window/Canvas/btn_cancel') as mw.Button
		}
	...
	public get text_cancel(): mw.TextBlock {
		if(!this.text_cancel_Internal&&this.uiWidgetBase) {
			this.text_cancel_Internal = this.uiWidgetBase.findChildByPath('RootCanvas/canvas_window/Canvas/btn_cancel/text_cancel') as mw.TextBlock
		}
	...
	public get btn_confirm(): mw.Button {
		if(!this.btn_confirm_Internal&&this.uiWidgetBase) {
			this.btn_confirm_Internal = this.uiWidgetBase.findChildByPath('RootCanvas/canvas_window/Canvas/btn_confirm') as mw.Button
		}
	...
	public get text_confirm(): mw.TextBlock {
		if(!this.text_confirm_Internal&&this.uiWidgetBase) {
			this.text_confirm_Internal = this.uiWidgetBase.findChildByPath('RootCanvas/canvas_window/Canvas/btn_confirm/text_confirm') as mw.TextBlock
		}
	...
	private img_bg001_2_Internal: mw.Image
	public get img_bg001_2(): mw.Image {
		if(!this.img_bg001_2_Internal&&this.uiWidgetBase) {
			this.img_bg001_2_Internal = this.uiWidgetBase.findChildByPath('RootCanvas/canvas_window/img_bg001_2') as mw.Image
		}
		return this.img_bg001_2_Internal
	}
	...
	protected initButtons() {
		...
		this.text_tipstitle.isRichText = true;
		
	
		this.initLanguage(this.text_tipscontent)
		this.text_tipscontent.isRichText = true;
		
	
		this.initLanguage(this.text_cancel)
		this.text_cancel.isRichText = true;
		
	
		this.initLanguage(this.text_confirm)
		this.text_confirm.isRichText = true;
		
	
		this.initLanguage(this.text_notips)
		this.text_notips.isRichText = true;
