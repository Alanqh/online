 ...
 export default class ShopDetail_UI_Generate extends UIScript {
	...
	private scroll_detail_Internal: mw.ScrollBox
	public get scroll_detail(): mw.ScrollBox {
		if(!this.scroll_detail_Internal&&this.uiWidgetBase) {
			this.scroll_detail_Internal = this.uiWidgetBase.findChildByPath('RootCanvas/canvas_detail/scroll_detail') as mw.ScrollBox
		}
		return this.scroll_detail_Internal
	}
	...
	public get text_introduce(): mw.TextBlock {
		if(!this.text_introduce_Internal&&this.uiWidgetBase) {
			this.text_introduce_Internal = this.uiWidgetBase.findChildByPath('RootCanvas/canvas_detail/scroll_detail/Canvas/text_introduce') as mw.TextBlock
		}
