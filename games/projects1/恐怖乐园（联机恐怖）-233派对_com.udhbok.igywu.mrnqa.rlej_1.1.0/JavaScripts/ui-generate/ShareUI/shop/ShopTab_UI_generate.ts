 ...
 export default class ShopTab_UI_Generate extends UIScript {
	...
	public get img_tabSelected(): mw.Image {
		if(!this.img_tabSelected_Internal&&this.uiWidgetBase) {
			this.img_tabSelected_Internal = this.uiWidgetBase.findChildByPath('RootCanvas/canvas_tab1/img_tabSelected') as mw.Image
		}
	...
	public get img_shopPoint(): mw.Image {
		if(!this.img_shopPoint_Internal&&this.uiWidgetBase) {
			this.img_shopPoint_Internal = this.uiWidgetBase.findChildByPath('RootCanvas/canvas_tab1/img_shopPoint') as mw.Image
		}
	...
	protected initButtons() {
		...
		this.text_tab1.isRichText = true;
