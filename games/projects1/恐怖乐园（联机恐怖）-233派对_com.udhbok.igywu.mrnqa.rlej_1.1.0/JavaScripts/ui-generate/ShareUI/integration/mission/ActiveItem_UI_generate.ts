 ...
 @UIBind('UI/ShareUI/integration/mission/ActiveItem_UI.ui')
 export default class ActiveItem_UI_Generate extends UIScript {
	...
	public get img_bg00(): mw.Image {
		if(!this.img_bg00_Internal&&this.uiWidgetBase) {
			this.img_bg00_Internal = this.uiWidgetBase.findChildByPath('mrootcanvas/canvas_ActSchedule/img_bg00') as mw.Image
		}
	...
	public get img_fr1(): mw.Image {
		if(!this.img_fr1_Internal&&this.uiWidgetBase) {
			this.img_fr1_Internal = this.uiWidgetBase.findChildByPath('mrootcanvas/canvas_ActSchedule/img_fr1') as mw.Image
		}
	...
	public get img_fr2(): mw.Image {
		if(!this.img_fr2_Internal&&this.uiWidgetBase) {
			this.img_fr2_Internal = this.uiWidgetBase.findChildByPath('mrootcanvas/canvas_ActSchedule/img_fr2') as mw.Image
		}
	...
	public get text_actNow(): mw.TextBlock {
		if(!this.text_actNow_Internal&&this.uiWidgetBase) {
			this.text_actNow_Internal = this.uiWidgetBase.findChildByPath('mrootcanvas/canvas_ActSchedule/text_actNow') as mw.TextBlock
		}
	...
	public get img_quest(): mw.Image {
		if(!this.img_quest_Internal&&this.uiWidgetBase) {
			this.img_quest_Internal = this.uiWidgetBase.findChildByPath('mrootcanvas/canvas_ActSchedule/img_quest') as mw.Image
		}
	...
	public get text_tips(): mw.TextBlock {
		if(!this.text_tips_Internal&&this.uiWidgetBase) {
			this.text_tips_Internal = this.uiWidgetBase.findChildByPath('mrootcanvas/canvas_ActSchedule/text_tips') as mw.TextBlock
		}
	...
	public get text_0(): mw.TextBlock {
		if(!this.text_0_Internal&&this.uiWidgetBase) {
			this.text_0_Internal = this.uiWidgetBase.findChildByPath('mrootcanvas/canvas_ActSchedule/text_0') as mw.TextBlock
		}
	...
	public get canvas_gift01(): mw.Canvas {
		if(!this.canvas_gift01_Internal&&this.uiWidgetBase) {
			this.canvas_gift01_Internal = this.uiWidgetBase.findChildByPath('mrootcanvas/canvas_ActSchedule/canvas_gift01') as mw.Canvas
		}
	...
	public get text_20(): mw.TextBlock {
		if(!this.text_20_Internal&&this.uiWidgetBase) {
			this.text_20_Internal = this.uiWidgetBase.findChildByPath('mrootcanvas/canvas_ActSchedule/canvas_gift01/text_20') as mw.TextBlock
		}
	...
	public get img_circle1(): mw.Image {
		if(!this.img_circle1_Internal&&this.uiWidgetBase) {
			this.img_circle1_Internal = this.uiWidgetBase.findChildByPath('mrootcanvas/canvas_ActSchedule/canvas_gift01/img_circle1') as mw.Image
		}
	...
	public get img_giftBr1(): mw.Image {
		if(!this.img_giftBr1_Internal&&this.uiWidgetBase) {
			this.img_giftBr1_Internal = this.uiWidgetBase.findChildByPath('mrootcanvas/canvas_ActSchedule/canvas_gift01/img_giftBr1') as mw.Image
		}
	...
	public get btn_gift1(): mw.Button {
		if(!this.btn_gift1_Internal&&this.uiWidgetBase) {
			this.btn_gift1_Internal = this.uiWidgetBase.findChildByPath('mrootcanvas/canvas_ActSchedule/canvas_gift01/btn_gift1') as mw.Button
		}
	...
	public get canvas_gift02(): mw.Canvas {
		if(!this.canvas_gift02_Internal&&this.uiWidgetBase) {
			this.canvas_gift02_Internal = this.uiWidgetBase.findChildByPath('mrootcanvas/canvas_ActSchedule/canvas_gift02') as mw.Canvas
		}
	...
	public get text_40(): mw.TextBlock {
		if(!this.text_40_Internal&&this.uiWidgetBase) {
			this.text_40_Internal = this.uiWidgetBase.findChildByPath('mrootcanvas/canvas_ActSchedule/canvas_gift02/text_40') as mw.TextBlock
		}
	...
	public get img_circle2(): mw.Image {
		if(!this.img_circle2_Internal&&this.uiWidgetBase) {
			this.img_circle2_Internal = this.uiWidgetBase.findChildByPath('mrootcanvas/canvas_ActSchedule/canvas_gift02/img_circle2') as mw.Image
		}
	...
	public get img_giftBr2(): mw.Image {
		if(!this.img_giftBr2_Internal&&this.uiWidgetBase) {
			this.img_giftBr2_Internal = this.uiWidgetBase.findChildByPath('mrootcanvas/canvas_ActSchedule/canvas_gift02/img_giftBr2') as mw.Image
		}
	...
	public get btn_gift2(): mw.Button {
		if(!this.btn_gift2_Internal&&this.uiWidgetBase) {
			this.btn_gift2_Internal = this.uiWidgetBase.findChildByPath('mrootcanvas/canvas_ActSchedule/canvas_gift02/btn_gift2') as mw.Button
		}
	...
	public get canvas_gift03(): mw.Canvas {
		if(!this.canvas_gift03_Internal&&this.uiWidgetBase) {
			this.canvas_gift03_Internal = this.uiWidgetBase.findChildByPath('mrootcanvas/canvas_ActSchedule/canvas_gift03') as mw.Canvas
		}
	...
	public get text_60(): mw.TextBlock {
		if(!this.text_60_Internal&&this.uiWidgetBase) {
			this.text_60_Internal = this.uiWidgetBase.findChildByPath('mrootcanvas/canvas_ActSchedule/canvas_gift03/text_60') as mw.TextBlock
		}
	...
	public get img_circle3(): mw.Image {
		if(!this.img_circle3_Internal&&this.uiWidgetBase) {
			this.img_circle3_Internal = this.uiWidgetBase.findChildByPath('mrootcanvas/canvas_ActSchedule/canvas_gift03/img_circle3') as mw.Image
		}
	...
	public get img_giftBr3(): mw.Image {
		if(!this.img_giftBr3_Internal&&this.uiWidgetBase) {
			this.img_giftBr3_Internal = this.uiWidgetBase.findChildByPath('mrootcanvas/canvas_ActSchedule/canvas_gift03/img_giftBr3') as mw.Image
		}
	...
	public get btn_gift3(): mw.Button {
		if(!this.btn_gift3_Internal&&this.uiWidgetBase) {
			this.btn_gift3_Internal = this.uiWidgetBase.findChildByPath('mrootcanvas/canvas_ActSchedule/canvas_gift03/btn_gift3') as mw.Button
		}
	...
	public get canvas_gift04(): mw.Canvas {
		if(!this.canvas_gift04_Internal&&this.uiWidgetBase) {
			this.canvas_gift04_Internal = this.uiWidgetBase.findChildByPath('mrootcanvas/canvas_ActSchedule/canvas_gift04') as mw.Canvas
		}
	...
	public get text_80(): mw.TextBlock {
		if(!this.text_80_Internal&&this.uiWidgetBase) {
			this.text_80_Internal = this.uiWidgetBase.findChildByPath('mrootcanvas/canvas_ActSchedule/canvas_gift04/text_80') as mw.TextBlock
		}
	...
	public get img_circle4(): mw.Image {
		if(!this.img_circle4_Internal&&this.uiWidgetBase) {
			this.img_circle4_Internal = this.uiWidgetBase.findChildByPath('mrootcanvas/canvas_ActSchedule/canvas_gift04/img_circle4') as mw.Image
		}
	...
	public get img_giftBr4(): mw.Image {
		if(!this.img_giftBr4_Internal&&this.uiWidgetBase) {
			this.img_giftBr4_Internal = this.uiWidgetBase.findChildByPath('mrootcanvas/canvas_ActSchedule/canvas_gift04/img_giftBr4') as mw.Image
		}
	...
	public get btn_gift4(): mw.Button {
		if(!this.btn_gift4_Internal&&this.uiWidgetBase) {
			this.btn_gift4_Internal = this.uiWidgetBase.findChildByPath('mrootcanvas/canvas_ActSchedule/canvas_gift04/btn_gift4') as mw.Button
		}
	...
	public get canvas_gift05(): mw.Canvas {
		if(!this.canvas_gift05_Internal&&this.uiWidgetBase) {
			this.canvas_gift05_Internal = this.uiWidgetBase.findChildByPath('mrootcanvas/canvas_ActSchedule/canvas_gift05') as mw.Canvas
		}
	...
	public get text_100(): mw.TextBlock {
		if(!this.text_100_Internal&&this.uiWidgetBase) {
			this.text_100_Internal = this.uiWidgetBase.findChildByPath('mrootcanvas/canvas_ActSchedule/canvas_gift05/text_100') as mw.TextBlock
		}
	...
	public get img_circle5(): mw.Image {
		if(!this.img_circle5_Internal&&this.uiWidgetBase) {
			this.img_circle5_Internal = this.uiWidgetBase.findChildByPath('mrootcanvas/canvas_ActSchedule/canvas_gift05/img_circle5') as mw.Image
		}
	...
	public get img_giftBr5(): mw.Image {
		if(!this.img_giftBr5_Internal&&this.uiWidgetBase) {
			this.img_giftBr5_Internal = this.uiWidgetBase.findChildByPath('mrootcanvas/canvas_ActSchedule/canvas_gift05/img_giftBr5') as mw.Image
		}
	...
	public get btn_gift5(): mw.Button {
		if(!this.btn_gift5_Internal&&this.uiWidgetBase) {
			this.btn_gift5_Internal = this.uiWidgetBase.findChildByPath('mrootcanvas/canvas_ActSchedule/canvas_gift05/btn_gift5') as mw.Button
		}
	...
	protected initButtons() {
		...
		this.btn_gift1.onClicked.add(()=>{
			Event.dispatchToLocal("PlayButtonClick", "ActiveItem_UI_btn_gift1");
		})
		...
		this.btn_gift2.onClicked.add(()=>{
			Event.dispatchToLocal("PlayButtonClick", "ActiveItem_UI_btn_gift2");
		})
		...
		this.btn_gift3.onClicked.add(()=>{
			Event.dispatchToLocal("PlayButtonClick", "ActiveItem_UI_btn_gift3");
		})
		...
		this.btn_gift4.onClicked.add(()=>{
			Event.dispatchToLocal("PlayButtonClick", "ActiveItem_UI_btn_gift4");
		})
		...
		this.btn_gift5.onClicked.add(()=>{
			Event.dispatchToLocal("PlayButtonClick", "ActiveItem_UI_btn_gift5");
		})
...
UIService['UI_ActiveItem_UI'] = ActiveItem_UI_Generate;