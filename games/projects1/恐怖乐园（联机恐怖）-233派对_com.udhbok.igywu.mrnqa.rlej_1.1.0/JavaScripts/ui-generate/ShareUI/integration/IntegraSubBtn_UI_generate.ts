 ...
 @UIBind('UI/ShareUI/integration/IntegraSubBtn_UI.ui')
 export default class IntegraSubBtn_UI_Generate extends UIScript {
	...
	public get img_bg0(): mw.Image {
		if(!this.img_bg0_Internal&&this.uiWidgetBase) {
			this.img_bg0_Internal = this.uiWidgetBase.findChildByPath('RootCanvas/canvas_btn/img_bg0') as mw.Image
		}
	...
	protected initButtons() {
		...
		this.btn_icon.onClicked.add(()=>{
			Event.dispatchToLocal("PlayButtonClick", "IntegraSubBtn_UI_btn_icon");
		})
...
UIService['UI_IntegraSubBtn_UI'] = IntegraSubBtn_UI_Generate;