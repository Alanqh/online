 ...
 @UIBind('UI/ShareUI/世界UI/UI_worldTips_01.ui')
 export default class UI_worldTips_01_Generate extends UIScript {
	 	private mRootCanvas_Internal: mw.Canvas
	public get mRootCanvas(): mw.Canvas {
		if(!this.mRootCanvas_Internal&&this.uiWidgetBase) {
			this.mRootCanvas_Internal = this.uiWidgetBase.findChildByPath('RootCanvas/mRootCanvas') as mw.Canvas
		}
	...
	public get canvas(): mw.Canvas {
		if(!this.canvas_Internal&&this.uiWidgetBase) {
			this.canvas_Internal = this.uiWidgetBase.findChildByPath('RootCanvas/mRootCanvas/canvas') as mw.Canvas
		}
	...
	public get text(): mw.TextBlock {
		if(!this.text_Internal&&this.uiWidgetBase) {
			this.text_Internal = this.uiWidgetBase.findChildByPath('RootCanvas/mRootCanvas/canvas/text') as mw.TextBlock
		}
...
UIService['UI_UI_worldTips_01'] = UI_worldTips_01_Generate;