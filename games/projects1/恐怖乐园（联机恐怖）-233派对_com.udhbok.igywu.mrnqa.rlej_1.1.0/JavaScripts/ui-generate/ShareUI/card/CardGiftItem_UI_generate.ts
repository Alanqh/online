 ...
 export default class CardGiftItem_UI_Generate extends UIScript {
	...
	public get text_total0(): mw.TextBlock {
		if(!this.text_total0_Internal&&this.uiWidgetBase) {
			this.text_total0_Internal = this.uiWidgetBase.findChildByPath('RootCanvas/canvas_buygift/canvas_buyBg01/canvas_buygiftFree/text_total0') as mw.TextBlock
		}
	...
	private canvas_buyTips_Internal: mw.Canvas
	public get canvas_buyTips(): mw.Canvas {
		if(!this.canvas_buyTips_Internal&&this.uiWidgetBase) {
			this.canvas_buyTips_Internal = this.uiWidgetBase.findChildByPath('RootCanvas/canvas_buyTips') as mw.Canvas
		}
		return this.canvas_buyTips_Internal
	}
	...
	public get text_soldtips2(): mw.TextBlock {
		if(!this.text_soldtips2_Internal&&this.uiWidgetBase) {
			this.text_soldtips2_Internal = this.uiWidgetBase.findChildByPath('RootCanvas/canvas_buyTips/text_soldtips2') as mw.TextBlock
		}
	...
	public get text_soldtips1(): mw.TextBlock {
		if(!this.text_soldtips1_Internal&&this.uiWidgetBase) {
			this.text_soldtips1_Internal = this.uiWidgetBase.findChildByPath('RootCanvas/canvas_buyTips/text_soldtips1') as mw.TextBlock
		}
	...
	protected initButtons() {
		...
		this.text_fireNum.isRichText = true;
		
	
		this.initLanguage(this.text_free)
		this.text_free.isRichText = true;
		
	
		this.initLanguage(this.text_coin2)
		this.text_coin2.isRichText = true;
		
	
		this.initLanguage(this.text_coin1)
		this.text_coin1.isRichText = true;
		...
		this.text_haveNum.isRichText = true;
		
	
		this.initLanguage(this.text_total1)
		this.text_total1.isRichText = true;
		
	
		this.initLanguage(this.text_total0)
		this.text_total0.isRichText = true;
		
	
		this.initLanguage(this.text_total2)
		this.text_total2.isRichText = true;
		
	
		this.initLanguage(this.text_total3)
		this.text_total3.isRichText = true;
		
	
		this.initLanguage(this.text_soldtips2)
		this.text_soldtips2.isRichText = true;
		
	
		this.initLanguage(this.text_soldtips1)
		this.text_soldtips1.isRichText = true;
