 ...
 export default class FriendRequest_UI_Generate extends UIScript {
	...
	public get bg2(): mw.Image {
		if(!this.bg2_Internal&&this.uiWidgetBase) {
			this.bg2_Internal = this.uiWidgetBase.findChildByPath('RootCanvas/canvas_friend1/bg2') as mw.Image
		}
	...
	protected initButtons() {
		...
		this.text_friendRequest.isRichText = true;
		...
		this.text_yes.isRichText = true;
		
	
		this.initLanguage(this.text_done)
		this.text_done.isRichText = true;
