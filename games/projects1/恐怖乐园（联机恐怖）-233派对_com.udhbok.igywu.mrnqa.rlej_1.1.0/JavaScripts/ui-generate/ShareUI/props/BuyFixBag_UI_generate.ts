 ...
 @UIBind('UI/ShareUI/props/BuyFixBag_UI.ui')
 export default class BuyFixBag_UI_Generate extends UIScript {
	...
	protected initButtons() {
		...
		this.btn_back.onClicked.add(()=>{
			Event.dispatchToLocal("PlayButtonClick", "BuyFixBag_UI_btn_back");
		})
		...
		this.btn_buyItem.onClicked.add(()=>{
			Event.dispatchToLocal("PlayButtonClick", "BuyFixBag_UI_btn_buyItem");
		})
		...
		this.btn_no.onClicked.add(()=>{
			Event.dispatchToLocal("PlayButtonClick", "BuyFixBag_UI_btn_no");
		})
		...
		this.text_question.isRichText = true;
		...
		this.text_num_1.isRichText = true;
		
	
		this.initLanguage(this.text_no)
		this.text_no.isRichText = true;
...
UIService['UI_BuyFixBag_UI'] = BuyFixBag_UI_Generate;