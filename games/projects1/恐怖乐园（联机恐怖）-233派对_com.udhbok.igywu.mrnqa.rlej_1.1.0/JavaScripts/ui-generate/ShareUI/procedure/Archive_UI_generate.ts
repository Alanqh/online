 ...
 export default class Archive_UI_Generate extends UIScript {
	...
	protected initButtons() {
		...
		this.text_save1.isRichText = true;
		
	
		this.initLanguage(this.text_diffi1)
		this.text_diffi1.isRichText = true;
