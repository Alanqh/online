 ...
 @UIBind('UI/ShareUI/unlock/UnlockTips_UI.ui')
 export default class UnlockTips_UI_Generate extends UIScript {
	...
	public get img_bg1_2(): mw.Image {
		if(!this.img_bg1_2_Internal&&this.uiWidgetBase) {
			this.img_bg1_2_Internal = this.uiWidgetBase.findChildByPath('RootCanvas/canvas_window/img_bg1_2') as mw.Image
		}
	...
	protected initButtons() {
		...
		this.btn_screen.onClicked.add(()=>{
			Event.dispatchToLocal("PlayButtonClick", "UnlockTips_UI_btn_screen");
		})
		...
		this.btn_cancel.onClicked.add(()=>{
			Event.dispatchToLocal("PlayButtonClick", "UnlockTips_UI_btn_cancel");
		})
		...
		this.btn_confirm.onClicked.add(()=>{
			Event.dispatchToLocal("PlayButtonClick", "UnlockTips_UI_btn_confirm");
		})
...
UIService['UI_UnlockTips_UI'] = UnlockTips_UI_Generate;