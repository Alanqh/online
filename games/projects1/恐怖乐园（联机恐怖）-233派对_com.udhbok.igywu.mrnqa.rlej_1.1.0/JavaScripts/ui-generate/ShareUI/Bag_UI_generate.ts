 ...
 export default class Bag_UI_Generate extends UIScript {
	...
	private textTreasureTips_Internal: mw.TextBlock
	public get textTreasureTips(): mw.TextBlock {
		if(!this.textTreasureTips_Internal&&this.uiWidgetBase) {
			this.textTreasureTips_Internal = this.uiWidgetBase.findChildByPath('mrootcanvas/canvas_bag/textTreasureTips') as mw.TextBlock
		}
		return this.textTreasureTips_Internal
	}
	...
	private btn_backpackrail6_Internal: mw.Button
	public get btn_backpackrail6(): mw.Button {
		if(!this.btn_backpackrail6_Internal&&this.uiWidgetBase) {
			this.btn_backpackrail6_Internal = this.uiWidgetBase.findChildByPath('mrootcanvas/canvas_tools/canvas_prop/btn_backpackrail6') as mw.Button
		}
		return this.btn_backpackrail6_Internal
	}
	private btn_backpackrail7_Internal: mw.Button
	public get btn_backpackrail7(): mw.Button {
		if(!this.btn_backpackrail7_Internal&&this.uiWidgetBase) {
			this.btn_backpackrail7_Internal = this.uiWidgetBase.findChildByPath('mrootcanvas/canvas_tools/canvas_prop/btn_backpackrail7') as mw.Button
		}
		return this.btn_backpackrail7_Internal
	}
	...
	protected initButtons() {
		...
		this.btn_backpackrail6.onClicked.add(()=>{
			Event.dispatchToLocal("PlayButtonClick", "Bag_UI_btn_backpackrail6");
		})
		this.btn_backpackrail6.touchMethod = (mw.ButtonTouchMethod.PreciseTap);
		this.btn_backpackrail6.onPressed.add(() => {
			this.btn_backpackrail6["preScale"] = this.btn_backpackrail6.renderScale;
			this.btn_backpackrail6.renderScale = Vector2.one.set(this.btn_backpackrail6["preScale"]).multiply(1.1);
		})
		this.btn_backpackrail6.onReleased.add(() => {
			this.btn_backpackrail6.renderScale = this.btn_backpackrail6["preScale"];
		})
		
	
		this.btn_backpackrail7.onClicked.add(()=>{
			Event.dispatchToLocal("PlayButtonClick", "Bag_UI_btn_backpackrail7");
		})
		this.btn_backpackrail7.touchMethod = (mw.ButtonTouchMethod.PreciseTap);
		this.btn_backpackrail7.onPressed.add(() => {
			this.btn_backpackrail7["preScale"] = this.btn_backpackrail7.renderScale;
			this.btn_backpackrail7.renderScale = Vector2.one.set(this.btn_backpackrail7["preScale"]).multiply(1.1);
		})
		this.btn_backpackrail7.onReleased.add(() => {
			this.btn_backpackrail7.renderScale = this.btn_backpackrail7["preScale"];
		})
		...
		this.text_normal.isRichText = true;
		
	
		this.initLanguage(this.text_special)
		this.text_special.isRichText = true;
		...
		this.initLanguage(this.textTreasureTips)
		this.textTreasureTips.isRichText = true;
