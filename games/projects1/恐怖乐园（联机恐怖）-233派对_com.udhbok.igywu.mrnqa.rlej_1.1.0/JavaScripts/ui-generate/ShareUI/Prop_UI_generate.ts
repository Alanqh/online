 ...
 export default class Prop_UI_Generate extends UIScript {
	...
	private img_line_1_Internal: mw.Image
	public get img_line_1(): mw.Image {
		if(!this.img_line_1_Internal&&this.uiWidgetBase) {
			this.img_line_1_Internal = this.uiWidgetBase.findChildByPath('mRootCanvas/canvas_prop/img_line_1') as mw.Image
		}
		return this.img_line_1_Internal
	}
	...
	protected initButtons() {
		...
		this.text_type.isRichText = true;
