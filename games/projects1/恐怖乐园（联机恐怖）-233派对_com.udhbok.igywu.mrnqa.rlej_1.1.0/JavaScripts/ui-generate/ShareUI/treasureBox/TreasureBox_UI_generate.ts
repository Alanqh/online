 ...
 export default class TreasureBox_UI_Generate extends UIScript {
	...
	private mText_openable_Internal: mw.TextBlock
	public get mText_openable(): mw.TextBlock {
		if(!this.mText_openable_Internal&&this.uiWidgetBase) {
			this.mText_openable_Internal = this.uiWidgetBase.findChildByPath('RootCanvas/canvas_boxdetail/mText_openable') as mw.TextBlock
		}
		return this.mText_openable_Internal
	}
	...
	private adsButton_Internal: mw.AdsButton
	public get adsButton(): mw.AdsButton {
		if(!this.adsButton_Internal&&this.uiWidgetBase) {
			this.adsButton_Internal = this.uiWidgetBase.findChildByPath('RootCanvas/canvas_boxdetail/canvas_open/adsButton') as mw.AdsButton
		}
		return this.adsButton_Internal
	}
	...
	protected initButtons() {
		...
		this.text_boxtitle.isRichText = true;
		
	
		this.initLanguage(this.text_boxtips)
		this.text_boxtips.isRichText = true;
		
	
		this.initLanguage(this.mText_openable)
		this.mText_openable.isRichText = true;
