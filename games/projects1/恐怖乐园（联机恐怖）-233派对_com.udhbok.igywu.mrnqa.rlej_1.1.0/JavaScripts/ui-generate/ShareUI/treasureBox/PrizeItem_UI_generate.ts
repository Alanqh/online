 ...
 export default class PrizeItem_UI_Generate extends UIScript {
	...
	private mTextgailv_Internal: mw.TextBlock
	public get mTextgailv(): mw.TextBlock {
		if(!this.mTextgailv_Internal&&this.uiWidgetBase) {
			this.mTextgailv_Internal = this.uiWidgetBase.findChildByPath('RootCanvas/canvas_item/mTextgailv') as mw.TextBlock
		}
		return this.mTextgailv_Internal
	}
	...
	protected initButtons() {
		...
		this.initLanguage(this.mTextgailv)
		this.mTextgailv.isRichText = true;
