 ...
 @UIBind('UI/walltips/walltips_library_UI.ui')
 export default class walltips_library_UI_Generate extends UIScript {
...
UIService['UI_walltips_library_UI'] = walltips_library_UI_Generate;