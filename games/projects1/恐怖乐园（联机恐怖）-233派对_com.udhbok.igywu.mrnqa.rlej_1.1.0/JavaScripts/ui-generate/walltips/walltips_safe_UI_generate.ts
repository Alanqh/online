 ...
 @UIBind('UI/walltips/walltips_safe_UI.ui')
 export default class walltips_safe_UI_Generate extends UIScript {
...
UIService['UI_walltips_safe_UI'] = walltips_safe_UI_Generate;