 ...
 @UIBind('UI/walltips/walltips_venture_UI.ui')
 export default class walltips_venture_UI_Generate extends UIScript {
...
UIService['UI_walltips_venture_UI'] = walltips_venture_UI_Generate;