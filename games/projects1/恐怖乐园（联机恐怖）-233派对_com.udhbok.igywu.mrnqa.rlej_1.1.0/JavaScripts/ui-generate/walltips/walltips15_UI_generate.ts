 ...
 @UIBind('UI/walltips/walltips15_UI.ui')
 export default class walltips15_UI_Generate extends UIScript {
	...
	public get text(): mw.TextBlock {
		if(!this.text_Internal&&this.uiWidgetBase) {
			this.text_Internal = this.uiWidgetBase.findChildByPath('RootCanvas/canvas/text') as mw.TextBlock
		}
...
UIService['UI_walltips15_UI'] = walltips15_UI_Generate;