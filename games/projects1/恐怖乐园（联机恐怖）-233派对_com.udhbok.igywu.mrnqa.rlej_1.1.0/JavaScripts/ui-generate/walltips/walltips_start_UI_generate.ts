 ...
 @UIBind('UI/walltips/walltips_start_UI.ui')
 export default class walltips_start_UI_Generate extends UIScript {
...
UIService['UI_walltips_start_UI'] = walltips_start_UI_Generate;