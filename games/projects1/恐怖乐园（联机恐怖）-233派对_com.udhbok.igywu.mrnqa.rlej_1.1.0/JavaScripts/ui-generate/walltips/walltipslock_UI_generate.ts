 ...
 @UIBind('UI/walltips/walltipslock_UI.ui')
 export default class walltipslock_UI_Generate extends UIScript {
...
UIService['UI_walltipslock_UI'] = walltipslock_UI_Generate;