 ...
 @UIBind('UI/walltips/walltipsredaim_UI.ui')
 export default class walltipsredaim_UI_Generate extends UIScript {
...
UIService['UI_walltipsredaim_UI'] = walltipsredaim_UI_Generate;