...
const EXCELDATA:Array<Array<any>> = [["id","name","hurt","hurtRate","otherStance","otherAtkAni","selfAtkToPos","selfAtkToRot","selfAtkTime","force","dirZIndex","attackSound","HitSound"],["","","","","","","","","","","","",""]];
