 ...
 * @LastEditors  : dal
 * @LastEditTime : 2024-05-11 13:58:53
 * @FilePath     : \1001_hall\JavaScripts\codes\utils\TimeTransferUtil.ts
 * @Description  : 
 */
...
export default class TimeTransferUtil {
    ...
    * @param timeStamp 时间戳
    */
    static getDateStr2ByTimeStamp(timeStamp: number) {
    ...
    * @returns 多少分
    */
    static getMiniStrByTimeSec(timeSec: number): string {
        if (timeSec < 0) { return ""; }
        let minute = timeSec / 60;
