 ...
 * @LastEditTime: 2024-05-20 10:27:48
 * @FilePath: \1001_hall\JavaScripts\codes\utils\UtilEx.ts
 * @Description: 
 */
 ...
 */
		...
		*/
		...
		export function transformIn(
			...
			switch (dir) {
				case Direction.Top:
					startInfo.setPosition(new mw.Vector2(widget.position.x, -widget.size.y));
					break;
				case Direction.Bottom:
					startInfo.setPosition(new mw.Vector2(widget.position.x, mw.getViewportSize().y + widget.size.y));
					break;
				case Direction.Left:
					startInfo.setPosition(new mw.Vector2(-widget.size.x, widget.position.y));
					break;
				case Direction.Right:
					startInfo.setPosition(new mw.Vector2(mw.getViewportSize().x + widget.size.x, widget.position.y));
					break;
				default:
		...
		export function transformOut(
			...
			switch (dir) {
				case Direction.Top:
					endInfo.setPosition(new mw.Vector2(widget.position.x, -widget.size.y));
					break;
				case Direction.Bottom:
					endInfo.setPosition(new mw.Vector2(widget.position.x, mw.getViewportSize().y + widget.size.y));
					break;
				case Direction.Left:
					endInfo.setPosition(new mw.Vector2(-widget.size.x, widget.position.y));
					break;
				case Direction.Right:
					endInfo.setPosition(new mw.Vector2(mw.getViewportSize().x + widget.size.x, widget.position.y));
					break;
				default:
					console.error("[UIAnimUtil] 该动画不能使用此方向");
					return;
	...
	*/
	...
	export class StateMachine<T> {
		...
		*/
		...
		public getCurStateObj() {
			return this._states.get(this.currentState)
