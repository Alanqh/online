 ...
 * @LastEditors  : dal
 * @LastEditTime : 2024-03-13 13:45:48
...
export class ItemUseBox extends BagUse_UI_Generate {
    ...
    protected onShow(cfg: IItemElement, data: BagItemData) {
        ...
        const qualityID = cfg.quality === 0 ? 1 : cfg.quality;
        this.itemImg_bg.imageGuid = GameConfig.ItemQuality.getElement(qualityID).imgGuid;
