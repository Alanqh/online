 ...
 * @Date         : 2024-04-16 16:15:30
 * @LastEditors  : sen.yu sen.yu@appshahe.com
 * @LastEditTime : 2024-04-26 18:00:41
 * @FilePath     : \hauntedparadise\JavaScripts\codes\modules\equip\items\BrandItem.ts
 * @Description  : 
 */
...
export class BrandItem extends Item {
     ...
     * @param element 道具元素
     */
    public async onUse(element: IItemElement): Promise<boolean> {
        /** 打开输入框 */
