...
export default class CGPlayer extends Script {
    ...
    protected onStart(): void {
        ...
        Event.addLocalListener("CGPlayer", (GOID: string) => {
            ...
            Event.dispatchToLocal("OnCGPlayer", true)
    ...
    private playAni() {
        ...
        let child = null;
        if (this._curIndex < this.nodeArr.length) {
            child = this.gameObject.getChildByName(this.nodeArr[this._curIndex])
        ...
        if (!cgelem) {
            ...
            Event.dispatchToLocal("OnCGPlayer", false)
