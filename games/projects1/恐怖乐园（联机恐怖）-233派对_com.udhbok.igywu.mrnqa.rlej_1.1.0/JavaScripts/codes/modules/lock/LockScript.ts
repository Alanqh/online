 ...
 * @LastEditors  : dal
 * @LastEditTime : 2024-06-13 16:36:20
 * @FilePath     : \1004_graveyard\JavaScripts\codes\modules\lock\LockScript.ts
 * @Description  : 
 */
...
export default class LockScript extends LevelBase {
    ...
    @mw.Property({ displayName: "已知密码" })
    public knownNumber: string = "";
    ...
    protected onLevelStart(): void {
        ...
        if (SystemUtil.isClient()) {
            ...
            this.addLocalListen(InterEvtNameDef.showLockUIEvtName, (guid: string) => {
                ...
                mw.UIService.show(LockUI, guid, this.id, this.knownNumber);
            })
