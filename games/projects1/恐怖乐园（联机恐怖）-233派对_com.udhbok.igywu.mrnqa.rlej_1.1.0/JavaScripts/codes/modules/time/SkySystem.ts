...
export default class SkySystem extends Script {
	...
	/**第i个光强到第i+1个光强持续的时间 */
	intensityTime = GameConfig.SubGlobal.lerpTime.array1d;

	/**天空光强 */
	skyBoxLightIntensity = GameConfig.SubGlobal.skyBoxLightIntensity.array1d;
	/**太阳光颜色 */
	sunColor = GameConfig.SubGlobal.sunColor.stringList;
	/** 平行光强*/
	skyLightIntensity = GameConfig.SubGlobal.lightingIntensity.array1d;
	/**天空球上层颜色 */
	skyBoxTopColor = GameConfig.SubGlobal.skyBoxTopColor.stringList;
	/**天空球中层颜色 */
	skyBoxMiddleColor = GameConfig.SubGlobal.skyBoxMiddleColor.stringList;
	/**天空球下层颜色 */
	skyBoxBottomColor = GameConfig.SubGlobal.skyBoxBottomColor.stringList;
	...
	public initDefaultValue() {
		...
		this.isInMoon = false;
		/**天空光强 */
		this.skyBoxLightIntensity = GameConfig.SubGlobal.skyBoxLightIntensity.array1d
		/**太阳光颜色 */
		this.sunColor = GameConfig.SubGlobal.sunColor.stringList;
		/** 平行光强*/
		this.skyLightIntensity = GameConfig.SubGlobal.lightingIntensity.array1d;
		/**天空球上层颜色 */
		this.skyBoxTopColor = GameConfig.SubGlobal.skyBoxTopColor.stringList;
		/**天空球中层颜色 */
		this.skyBoxMiddleColor = GameConfig.SubGlobal.skyBoxMiddleColor.stringList;
		/**天空球下层颜色 */
		this.skyBoxBottomColor = GameConfig.SubGlobal.skyBoxBottomColor.stringList;
		this.init();
	}

	public initRedMoonValue() {
		if (this.isInMoon) {
			return;
		}
		this.isInMoon = true;
		/**天空光强 */
		this.skyBoxLightIntensity = GameConfig.SubGlobal.skyBoxLightIntensityMoon.array1d
		/**太阳光颜色 */
		this.sunColor = GameConfig.SubGlobal.sunColorMoon.stringList;
		/** 平行光强*/
		this.skyLightIntensity = GameConfig.SubGlobal.lightingIntensityMoon.array1d;
		/**天空球上层颜色 */
		this.skyBoxTopColor = GameConfig.SubGlobal.skyBoxTopColorMoon.stringList;
		/**天空球中层颜色 */
		this.skyBoxMiddleColor = GameConfig.SubGlobal.skyBoxMiddleColorMoon.stringList;
		/**天空球下层颜色 */
		this.skyBoxBottomColor = GameConfig.SubGlobal.skyBoxBottomColorMoon.stringList;
		this.init();
		console.log("改变为红月填")
	}
