 ...
 * @LastEditors  : dal
 * @LastEditTime : 2024-05-09 11:03:22
 * @FilePath     : \1004_graveyard\JavaScripts\codes\modules\ghost\GhostInst.ts
 * @Description  : 
 */
...
export default class GhostInst extends mw.Script {
    ...
    cli_killChar(player: Player, dir: Vector) {
        ...
        ModuleService.getModule(GhostModuleC).killPlayer(this.graphicCfg.attackDelayUI, this.graphicCfg.stopTime, ani, this.ghostChar, this.graphicCfg, dir, this._insCfg, 0);
    }
    ...
    async onCfgIdChanged() {
        ...
        ModuleService.getModule(GhostModuleC).regPart(this.gameObject.gameObjectId, this.gameObject.gameObjectId);
    }
    ...
    client_checkGhostSight(dt: number) {
        ...
        if (ghostModule.isKilling || ghostModule.isinvinci || ghostModule.isInsafe) {
            return;
        }
