 ...
 * @LastEditors  : dal
 * @LastEditTime : 2024-03-19 14:04:11
...
export default class ArchiveModuleC extends ModuleC<ArchiveModuleS, PlayerArchiveData> {
    ...
    async forceSaveData(properties: string[], values: any[], archiveId: number): Promise<void> {
        if (archiveId < 0 || archiveId > 2) { return; }
        this.server.net_forceSaveData(this.localPlayer.userId, properties, values, archiveId);
    }
