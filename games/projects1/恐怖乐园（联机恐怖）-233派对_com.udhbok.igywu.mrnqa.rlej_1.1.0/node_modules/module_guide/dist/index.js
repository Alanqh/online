...
class GuideModuleView extends exports.GuideModuleUI_Generate {
    ...
    lockMWUIWidget(target, callback, tips = "", isShowBtn = true) {
        ...
        let btnHandPos = this.mBtn.position.clone(); //.addition(mw.Vector2.zero);
        let btnHandSize = this.mBtn.size.clone(); //.addition(mw.Vector2.zero);
        if (this._outViewPos.y < viewportSize.y / 2) {
            ...
            if (this._outViewPos.x < viewportSize.x / 2) {
                this.mTextHand.position =
                    new mw.Vector2(btnHandPos.x, btnHandPos.y - btnHandSize.y - size.y);
            }
            else {
                this.mTextHand.position =
                    new mw.Vector2(btnHandPos.x, btnHandPos.y - size.y);
            }
        }
        // 设置button区域
